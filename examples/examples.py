...
def example_conestrip1():
    ...
    Omega_Gamma = [0, 1, 2]
    Omega_Delta = [0, 1, 2]
    result1 = solve_conestrip1(R, f, Omega_Gamma, Omega_Delta, verbose=True)
    result2 = solve_conestrip2(R, f, Omega_Gamma, Omega_Delta, verbose=True)
    result3 = solve_conestrip3(R, f, Omega_Gamma, Omega_Delta, verbose=True)
