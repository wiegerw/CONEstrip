...
def random_inside_point(R: ConeGenerator) -> Gamble:
    """
    ...
    return linear_combination(lambda_, R.gambles)


def random_border_point(R: ConeGenerator) -> Gamble:
    """
    ...
    print('border_facet', border_facet)
...
def add_random_border_cone(R: ConeGenerator) -> ConeGenerator:
    ...
    result = []
    for i in range(m):
        g = random_inside_point(border_facet)
        result.append(g)
